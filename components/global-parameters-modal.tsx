...
export function GlobalParametersModal({ onClose, language }: GlobalParametersModalProps) {
  ...
  const translations = {
    ...
    nl: {
      ...
      subtitle: "Klasdoelstelling: aanwezigheidsdrempel en prestatiedrempel",
      globalSettings: "Globale Instellingen",
      attendanceThreshold: "Aanwezigheidsdrempel",
      attendanceDesc: "Klasdoelstelling voor minimale aanwezigheid",
      individualGoal: "Prestatiedrempel",
      individualGoalDesc: "Klasdoelstelling voor minimale competentiebehaald",
      classSettings: "Klasdoelstellingen",
